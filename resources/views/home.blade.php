    ...
    <div class="navbar navbar-dark bg-dark shadow-sm">
        <div class="container">
            ...
            @if(auth()->check())
                <a href="">
                    @if(auth()->user()->avatar)
                        <img src="{{asset('storage/'. auth()->user()->avatar)}}" class="avatarUserProfile">
                    @endif
                        {{auth()->user()->name}}
                </a>
                <a href="{{route('logout')}}" class="btn btn-secondary my-2">Logout</a>
            @else
                <a href="{{route('register.create')}}" class="btn btn-primary my-2">Register</a>
                <a href="{{route('login.create')}}" class="btn btn-secondary my-2">Login</a>
            @endif
